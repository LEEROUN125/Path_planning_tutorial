...
protected:
    ...
    float pathCost;
    float planningTimeMs;
    
public:
    PathPlanner(AlgorithmType type, const Map* mapPtr = nullptr, const Robot* robotPtr = nullptr);
    ...
    // Utility functions
    float calculatePathLength(const std::vector<PathPoint>& path) const;
